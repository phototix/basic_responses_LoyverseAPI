...
require("formBuilder/controller/conn.php");
require("formBuilder/controller/functions.php");
require("formBuilder/controller/common.php");
...
$sendMessage="*[Alert!]* \nNew WebHook Update from POS System \n".$data;
